...
namespace game
{
    ...
    public:
        ...
        virtual std::tuple<int, size_t> add(game::particles& particles, ff::point_fixed pos, const game::particle_effect_options* options = nullptr) const = 0;
        virtual std::tuple<int, size_t> add(game::particles& particles, const ff::point_fixed* pos, size_t pos_count, const game::particle_effect_options* options = nullptr) const = 0;
    };
    ...
    private:
        ...
        public:
            spec_t() = default;
            spec_t(game::particles::spec_t&&) = default;
            spec_t(const game::particles::spec_t&) = default;
            spec_t(const ff::dict& dict);

            spec_t& operator=(game::particles::spec_t&&) = default;
            spec_t& operator=(const game::particles::spec_t&) = default;

            size_t add(particles& particles, ff::point_fixed pos, int effect_id, const game::particle_effect_options& options) const;
        ...
        ff::win_event async_event;
        ff::signal<int> effect_done_signal;

    public:
        class effect_t : public game::particle_effect_base
        {
        public:
            effect_t() = default;
            effect_t(game::particles::effect_t&&) = default;
            effect_t(const game::particles::effect_t&) = default;
            effect_t(const ff::value* value);

            game::particles::effect_t& operator=(game::particles::effect_t&&) = default;
            game::particles::effect_t& operator=(const game::particles::effect_t&) = default;

            virtual std::tuple<int, size_t> add(game::particles& particles, ff::point_fixed pos, const game::particle_effect_options* options = nullptr) const override;
            virtual std::tuple<int, size_t> add(game::particles& particles, const ff::point_fixed* pos, size_t pos_count, const game::particle_effect_options* options = nullptr) const override;
